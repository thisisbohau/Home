...
//    @ObservedObject var timer = WebRequest()
    ...
    var body: some View{
        if UIDevice.current.userInterfaceIdiom == .pad{
            ZStack{
                ...
                .navigationTitle("Welcome Home, David")
        }else{
            NavigationView{
                ZStack{
                    VStack{
...
struct Dashboard: View {
    ...
    private let player = AVPlayer(url: URL(string: "https://video.nest.com/embedded/live/HrNOAkOObX")!)
...
//            nfc.startScanning()
//        })
//        .onChange(of: nfc.selectedRoom, perform: {Room in
