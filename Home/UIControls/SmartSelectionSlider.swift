//
//  SmartSelectionSlider.swift
//  Home
//
//  Created by David Bohaumilitzky on 17.12.21.
//
...
struct SelectionPoint: Identifiable{
    var id: Int
    var icon: AnyView
    var title: String
}
struct SmartSelectionSlider: View {
        ...
        HStack{
            VStack{
                Spacer()
                    ...
                    .padding(10)
                    .onCondition(!(noBackground ?? false), transform: {view in
                        view
...
//struct SmartSelectionSlider_Previews: PreviewProvider {
//    static var previews: some View {
//        GeometryReader{proxy in
//            SmartSelectionSlider(controlSize: 45, availableSpace: proxy.size.height/2, selectColor: .orange)
//        }
//
//    }
//}
