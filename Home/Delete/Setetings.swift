...
//    @State var newAccess: Bool = false
//
...
//                    Button(action: {newAccess.toggle()}){
//                        Text("Add Device")
//                    }
//                }
//                Section("AccessControl"){
//                    Button(action: {
//                        AccessKit().sessionStart(lastLocation: location.lastLocation!)
//
//                    }){
//                        Text("Add Session")
//                    }
...
//                    RoomTagSetup()
//                }
//                .sheet(isPresented: $newAccess){
//                    NewDeviceAccess(show: $newAccess)
//                }
