...
class AppState: ObservableObject{
    @Published var activeRoom: Room = Room(id: 0, name: "", floor: 0, lights: [Light](), blinds: [Blind](), tempDevices: [TempDevice](), type: RoomType(icon: "", color: ""), occupied: false, lastOccupied: "", openWindow: false, windows: [WindowSensor]())
